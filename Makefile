...
test_env_up:
	docker-compose -f ./postgres-driver/docker-compose.test.yml up -d --remove-orphans --build;
	sleep 2;
test_env_down:
	docker-compose -f ./postgres-driver/docker-compose.test.yml down --remove-orphans -v
run_driver_tests:
